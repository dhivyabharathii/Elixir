defmodule RecipeOrganizerWeb.RecipeControllerTest do
  use RecipeOrganizerWeb.ConnCase

  import RecipeOrganizer.RecipesFixtures

  @create_attrs %{cook_time: 42, ingredients: "some ingredients", instructions: "some instructions", prep_time: 42, title: "some title"}
